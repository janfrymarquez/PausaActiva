...
++$contador; endforeach; ?>
  ...
  function GuardarEncuesta(){
    ...
    var InsertarDatos = JSON.stringify(nuevoResultado);
    var Actualizar = JSON.stringify(result);
...
type: 'POST',
url: '../Controlador/GuardarEditarEncuesta.php',
data: 'InsertarDatos=' +InsertarDatos,
...
$(document).ready(function(){
  ...
  $('.add').click(function(){
    ...
    ?></select></div><div class ="form-group col-md-1"><button type="button" name="remove" id="'+i+'"  class="btn btn-danger btn_remove"><i class="fa fa-trash-o fa-lg" aria-hidden="true" ></i></button></div></div><div class="form-group col-md-12 "  class = "DivOpciones Repuesta" id="Rep'+i+'"></div></div>');
