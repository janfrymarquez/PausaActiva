...
?>
                        ...
                        <div id="DesactivarPermiso" class="modal fade">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <form id="eliminarDatos">
                                <div class="modal-header">
                                  <h4 class="modal-title">Desactivar Permiso</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                      </div>
                                        <div class="modal-body">
                                          <div  id="DesactivarPermisoUser" class="borrarClienteMensaje"></div>
                                          <p class="text-warning"><small>Si esta seguro pulse Desactivar</small></p>
                                        </div>
                                      <div class="modal-footer">
                                  <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
                                  <input type="submit"  class="btn btn-danger" id="btnDesactivarPermiso" value="Desactivar">
                                </div>
                        ...
                        <div id="ActivarPermiso" class="modal fade">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <form id="ActivarPermiso">
                                <div class="modal-header">
                                  <h4 class="modal-title">Activar permiso para loguearse en el sistema</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                      </div>
                                        <div class="modal-body">
                                          <div  id="UserNoDisponibles">  </div>
                                          <input type="text" class= "form-control required txt_idClientePA hidden "  name="IdCliente" id ="txt_idClientePA"  />
                                          <input type="text" class= "form-control required txt_NombreAP hidden "  name="txt_NombreAP" id ="txt_NombreAP"  />
                                          <input type="text" class= "form-control required txt_EmailAP hidden "  name="txt_EmailAP" id ="txt_EmailAP"  />
                                          <input type="text" class= "form-control required txt_Apellidoap hidden "  name="txt_Apellidoap" id ="txt_Apellidoap"  />
                                           <div id="Usuario-group" class="form-group has-feedback">
                                            		<label>Usuario</label>
                                            		<input type="text" class= "form-control"  name= "Usuario" id ="txt_username"  required />
                                                <span id="iconForm" class="form-control-feedback SpanUser "></span>
                                                <div class="Error_Usuario error"></div>
                                            </div>
                                            ...
                                            <div id="PermisoUser-group" class="form-group has-feedback">
                          										<label>Permisos</label>
                          											<select class="form-control " name="Permisos" id="permisoUsuario" required>
                                                ...
                                                $sql = 'SELECT * FROM  tbl_permisos_usuarios WHERE Activo = :Activo';
                                                    ...
                                                    <div class="Error_PermisoUsar error"></div>
                          									 </div>

                                               <p class="text-warning">La contraseña por defecto es <strong>EncuestaBon</strong>  Se le solicitara cambiarla al iniciar </p>
                                  ...
                                  <input   class="btn btn-info " id="EnviarPermisoUsuario" disabled value="Enviar">
                                </div>
