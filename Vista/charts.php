...
<head>
	...
	<title>Pausa Activa -Estadisticas</title>
...
?>
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="charts.php"><em class="fa fa-bar-chart">&nbsp;</em> Estadistica</a></li>
			<li><a href="elements.php"><em class="fa fa-toggle-off">&nbsp;</em> Administrar P Activa </a></li>
