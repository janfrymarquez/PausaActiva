...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _initClickable: function() {
            ...
            self._handler($zone, 'click', function(e) {
                var $tar = $(e.target);
                if (!$zone.find('.kv-fileinput-error:visible').length && (!$tar.parents('.file-preview-thumbnails').length || $tar.parents('.file-default-preview').length)) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneTitle: 'Arraste la imagen aqui &hellip;',
